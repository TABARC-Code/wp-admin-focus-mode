...
class WP_Admin_Focus_Mode {
    ...
    public function render_settings_page() {
        ...
        <div class="wrap">
            ...
            <form method="post" action="options.php">
                ...
                <p class="description">
                    This keeps the interface less intimidating. Admins keep the full view. Focus roles see less clutter.
                </p>
     ...
     *
     * If a role has a redirect configured, I use it. Otherwise I respect whatever WordPress chose.
     */
